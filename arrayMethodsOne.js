...
// CODE HERE
const taxatation = orders.map((obj) => obj.price * (obj.tax + 1))
// console.log(taxatation)
...
// CODE HERE
const bobsTotal = purchases.filter(obj => obj.owner === `Bob`).map(element => element.price).reduce((acc, cur) => acc + cur)
